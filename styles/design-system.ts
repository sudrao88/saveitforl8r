...
export const overlay = {
  ...
  sheetEnter: 'animate-in slide-in-from-bottom-full duration-(--duration-sheet) ease-out',
  sheetExit: 'animate-out slide-out-to-bottom-full fill-mode-forwards pointer-events-none duration-(--duration-sheet) ease-in',
  modalEnter: 'animate-in slide-in-from-bottom-full duration-(--duration-slow) ease-out',
  modalExit: 'animate-out slide-out-to-bottom-full fill-mode-forwards pointer-events-none duration-(--duration-slow) ease-in',
  backdropEnter: 'animate-in slide-in-from-bottom-full duration-(--duration-slow) ease-out',
  backdropExit: 'animate-out slide-out-to-bottom-full fill-mode-forwards pointer-events-none duration-(--duration-slow) ease-in',
  ...
  viewEnter: 'animate-in slide-in-from-bottom-full duration-(--duration-slow) ease-out',
  viewExit: 'animate-out slide-out-to-bottom-full fill-mode-forwards pointer-events-none duration-(--duration-slow) ease-in',
...
export const checklist = {
  ...
  subItemRow: 'flex items-start gap-3 pl-8',
