// public/sw.js
const CACHE_NAME = 'saveitforl8r-v54'; // Increment version to force update
...
<head>
  ...
  <style>
    body {
      ...
      justify-content: center; background: #000; color: #f3f4f6;
    ...
    .spinner {
      width: 1.5rem; height: 1.5rem; border: 2px solid #374151;
      border-top-color: #2563eb; border-radius: 50%;
      animation: spin 1s linear infinite; margin: 0 auto 1rem;
    }
    @keyframes spin { to { transform: rotate(360deg); } }
    button {
      background: #2563eb; color: #f3f4f6; border: none;
...
<body>
  <div class="container">
    ...
    <p id="retry-msg" class="hidden">Still trying\u2026 retrying in <span id="countdown"></span>s</p>
