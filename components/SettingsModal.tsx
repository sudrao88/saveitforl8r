...
import { factoryReset } from '../services/storageService';
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-3xl max-w-md w-full shadow-2xl relative max-h-[85vh] flex flex-col overflow-hidden">
        ...
        {/* Fixed Header Area (Optional, currently Close button is absolute) */}
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-gray-700/30 p-4 rounded-2xl border border-gray-700 space-y-4">
                            ...
                            {lastError && (
                                <div className="bg-red-900/20 border border-red-900/50 p-3 rounded-lg flex items-start gap-2">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-xs font-bold text-red-300">System Error</p>
                                        <p className="text-[10px] text-red-300/80 break-words font-mono mt-1">{lastError}</p>
                                    </div>
                                </div>
                            )}
                            ...
                            {modelStatus === 'error' && !lastError && (
                                <div className="flex items-center justify-between">
                                    <span className="text-xs text-red-400 flex items-center gap-1">
                                        <AlertTriangle size={12} /> Setup Failed
                                    </span>
                                    <button 
                    ...
                    <div className="space-y-3 pt-4 border-t border-red-900/30">
                        ...
                        <button 
                            onClick={() => {
                                if (window.confirm("Are you sure you want to factory reset? This will delete ALL local data. Ensure you have a backup.")) {
                                    factoryReset();
                                }
                            }}
                            className="w-full flex items-center justify-between px-4 py-3 bg-red-950/30 hover:bg-red-900/40 text-red-400 rounded-xl font-medium transition-colors border border-red-900/30 hover:border-red-800 group"
                        >
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-red-900/20 rounded-lg group-hover:bg-red-900/30 transition-colors">
                                ...
                                <div className="text-left">
                                    <span className="block text-sm font-bold text-red-200 group-hover:text-white">Factory Reset App</span>
                                    <span className="block text-xs text-red-400/70">Wipe all data and start fresh</span>
                                </div>
                            </div>
                        </button>
                    </div>
