...
DISAMBIGUATION RULES:
- Recipe vs. Product: If the fetched content contains an ingredient list (quantities + foods) or cooking/baking/preparation steps, classify as 'recipe'. Brand names of ingredients or recipe titles that reference branded ingredients do NOT make it a product. Use 'product' only when the content is about evaluating, comparing, or shopping for a specific item.
- Honor user tags: tags like #Recipe, #Baking, #Dessert strongly indicate 'recipe'; tags like #Shopping, #Wishlist indicate 'product' or 'wishlist'.
